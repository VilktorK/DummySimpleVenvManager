...
- Use "Hot Commands" for easily executing commands inside of the venv without having to type or memorize them.
- Set "Working Directory" to always open the venv inside of a specific directory for less "cd"ing.
